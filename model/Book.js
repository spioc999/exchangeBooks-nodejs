...
function Insertion(id, isbn, title, authors, publishedDate, smallThumbnailLink, thumbnailLink, bookStatus, note, dateInsertion){
    this.id = id || null;
    this.isbn = isbn || null;
    this.title = title || null;
    this.authors = authors || null;
...
function InsertionFullDetails(username, email, lastName, firstName, city, isbn, title, authors, publishedDate, smallThumbnailLink, thumbnailLink, bookStatus, note, dateInsertion){
